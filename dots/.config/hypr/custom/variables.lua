...
taskManager = "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'command -v btop && kitty zsh -c -i btop' 'gnome-system-monitor' 'plasma-systemmonitor --page-name Processes'"
